...
VEHICLE_MODEL_PATH = r"C:\RAJIV\PROJECT\Intelligence Traffic Management System\runs\detect\emergency_vehicle_training2\weights\best.pt"
...
alerted_ids = set()  # will store strings like "A-12" or "V-5"
CONF_THRESHOLD = 0.70  # *************** CONFIDENCE LIMIT ***************
...
print("General model class names:", model.names)
